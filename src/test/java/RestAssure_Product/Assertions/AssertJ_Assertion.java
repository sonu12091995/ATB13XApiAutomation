...
public class AssertJ_Assertion {
    ...
    public void test_AssertJ() {
        ...
        // AssertJ assertions
        assertThat(id).isPositive().isNotNull().isNotZero();
        assertThat(title).isNotBlank().isEqualTo("Tshirt");
        assertThat(price).isGreaterThan(0).isNotZero().isNotNull().isPositive();
    }
}
